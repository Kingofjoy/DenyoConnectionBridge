...
namespace Denyo.ConnectionBridge.CommunicationManager
{
    class CommunicationManager
    {
        ...
        {
            Console.WriteLine(DateTime.Now.ToString("HH:mm:ss:ff ") + Enum.GetName(typeof(MessageType), type) + " CM> " + msg);
